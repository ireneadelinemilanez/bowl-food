...
export function load() {
  ...
  lines.forEach((line) => {
    if (!line.trim()) return;
    const [date, cpiAwayFood, medIncHouse, avgChipotle, avgCava, avgSweetgreen, cpiZeroIndex, houseZeroIndex, chiptoleZeroIndex, cavaZeroIndex, sweetgreenZeroIndex] = line.split(',');
